 ...
 */
$config['document_root'] = $_SERVER['DOCUMENT_ROOT']; //"812local/";// $_SERVER['DOCUMENT_ROOT']; //"/nfs/c01/h11/mnt/7230/domains/812studio.com/html/";
 ...
 * when in production.
 */
$config['cache_lifetime'] = 1; // 3600 will check if it needs to recache every hour
